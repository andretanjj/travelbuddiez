...
function TravelPlanningPage() {
    ...
    const filteredHotels = useMemo(() => {
        return mockHotels
            .filter((hotel) => {
                const searchText = `${hotel.name} ${hotel.city} ${hotel.country}`.toLowerCase();
                return searchText.includes(searchTerm.toLowerCase());
            })
            .sort((a, b) => a.price - b.price);
    }, [searchTerm]);
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex gap-3 mb-6">
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2 rounded-full border transition ${activeTab === "flights"
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2 rounded-full border transition ${activeTab === "hotels"
                            ? "bg-amber-500 text-slate-950 border-amber-500"
                            : "bg-slate-900 text-slate-300 border-slate-700 hover:border-slate-500"
                            }`}
                    >
                            ...
                            {filteredFlights.map((flight) => (
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="text-slate-400 text-sm">{flight.route}</p>
