...
// OLD VERSION: used frontend mock data
...
function DestinationDashboardPage() {
  const { countryCode } = useParams(); // reads countryCode fromURL, ie /destinations/SGP

  // OLD VERSION
  // const destination = mockDestinations.find((destination) => destination.countryCode === countryCode);

  // NEW VERSION: destination data comess from backend API
  const [destination, setDestination] = useState<Destination | null>(null);

  // track whether data is still being fethced
  const [isLoading, setIsLoading] = useState<boolean>(true);

  // stores err msg if backend request fails
